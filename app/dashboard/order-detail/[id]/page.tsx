    ...
    return (
        ...
        <div className="p-2 text-black overflow-y-scroll max-h-[90vh]">
            ...
            <div className="rounded-md px-2 mb-1 bg-white">
                ...
                <div className="flex justify-between border-b py-2">
                    <p>🔻 Số tiền giảm</p>
                    <p className="text-green-600 text-right">{(Number(order.invoice.discount) / 100* order.invoice.amount).toLocaleString()}</p>
                </div>
                    ...
                    <>
                        ...
                        <div className="w-full p-4 fixed bottom-0 bg-white font-bold z-50 shadow-lg rounded-t-xl">
                            <div className="flex flex-col gap-3 text-center">
                                ...
                                { role === "admin" && (<>
                                    <Link className="py-2 text-green-600" href={`/dashboard/order-detail/${order.invoice.id}/edit-order`}>✅ Xác nhận</Link>
